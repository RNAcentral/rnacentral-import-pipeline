...
#         (
#             "URS00006550DA_10090",
#             "Mus musculus (house mouse) small Cajal body-specific RNA 1 (Scarna13)",
#         ),
#         ("URS0000661037_7955", "Danio rerio tRNA"),
#         ("URS000069D7FA_6239", "Caenorhabditis elegans tRNA-His"),
#         (
#             "URS00006B3271_10090",
#             "Mus musculus (house mouse) small Cajal body-specific RNA 2 (Scarna2)",
#         ),
#         (
#             "URS00006CE02F_9606",
#             "Homo sapiens (human) snoRNA U8 small nucleolar RNA (RF00096)",
#         ),
...
@pytest.mark.parametrize(
    ...
    [  # pylint: disable=no-member
        ...
        ("URS00003BECAC_9606", "non-protein coding lnc-GPCPD1-8:9"),
        ...
        ("URS00004E52D3_10090", "predicted gene 12238"),
        ...
        (
            "URS00006550DA_10090",
            "small Cajal body-specific RNA 13 (ENSMUSG00002076601.1)",
        ),
        # ("URS0000661037_7955", "tRNA"),
        # ("URS000069D7FA_6239", "tRNA-His"),
        (
            "URS00006B3271_10090",
            "small Cajal body-specific RNA 2 (ENSMUSG00000088185.3)",
        ),
        ...
        ("URS0000759BEC_9606", "DiGeorge syndrome critical region gene 5 (DGCR5)"),
        # (
        #     "URS000075A546_9606",
        #     "microRNA hsa-mir-3648 precursor (hsa-mir-3648-1, hsa-mir-3648-2)",
        # ),
...
def test_strips_leading_species(rna_id, short):
    assert short == load_data(rna_id).short_description
...
#         pytest.param("URS0000A17B82_640938", True, marks=pytest.mark.xfail),
