...
@pytest.mark.parametrize('rna_id,description', [  # pylint: disable=no-member
    ...
    ('URS00006CE02F_9606', 'Homo sapiens (human) snoRNA U8 small nucleolar RNA (RF00096)'),
    ...
    pytest.param('URS0000A767C0_3702', 'Arabidopsis thaliana (thale cress) other RNA (AT1G44125)',
