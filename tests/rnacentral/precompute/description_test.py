...
@pytest.mark.parametrize('rna_id,rna_type,name', [  # pylint: disable=no-member
    ...
    ('URS000075A3E2_9606', 'precursor_RNA', 'Homo sapiens (human) microRNA precursor (hsa-mir-6859 1 to 4)'),
    ('URS000075A546_9606', 'precursor_RNA', 'Homo sapiens (human) microRNA precursor (hsa-mir-3648-1, hsa-mir-3648-2)'),
    ('URS000075B196_7955', 'precursor_RNA', 'Danio rerio (zebrafish) microRNA precursor (dre-mir-430c 1 to 18)'),
