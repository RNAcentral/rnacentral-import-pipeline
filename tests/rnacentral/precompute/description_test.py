...
@pytest.mark.parametrize('rna_id,rna_type,name', [  # pylint: disable=no-member
    ...
    ('URS000051DCEC_10090', 'snoRNA', 'Mus musculus small nucleolar RNA, C/D box 17 (Snord17)'),
    ...
    ('URS0000A767C0_3702', 'lncRNA', 'Arabidopsis thaliana potential natural antisense gene, locus overlaps with AT1G44120 (AT1G44125)'),
