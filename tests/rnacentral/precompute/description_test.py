...
@pytest.mark.parametrize('rna_id,rna_type,name', [  # pylint: disable=no-member
    ...
    pytest.param('URS000051DCEC_10090', 'snoRNA', 'Mus musculus small nucleolar RNA, C/D box 17 (Snord17)',
                 marks=pytest.mark.xfail(reason="RefSeq parsing")),
    ...
    pytest.param('URS000060B496_10090', 'snoRNA', 'Mus musculus small nucleolar RNA, H/ACA box 3 (Snora3)',
                 marks=pytest.mark.xfail(reason="RefSeq parsing")),
    ...
    pytest.param('URS0000A767C0_3702', 'lncRNA', 'Arabidopsis thaliana potential natural antisense gene, locus overlaps with AT1G44120 (AT1G44125)',
                 marks=pytest.mark.xfail(reason="RefSeq parsing")),
    ...
    ('URS0000A98E18_9606', 'Y_RNA', 'Homo sapiens (human) Y RNA (RF00019)'),
