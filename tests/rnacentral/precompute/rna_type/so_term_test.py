...
@pytest.mark.parametrize('rna_id,rna_type', [  # pylint: disable=no-member
    pytest.param('URS000004F67F_109352', 'rRNA_primary_transcript', marks=pytest.mark.xfail(reason="NYI")),
    pytest.param('URS0000050E80_67003', 'rRNA_primary_transcript', marks=pytest.mark.xfail(reason="NYI")),
    pytest.param('URS0000127C85_175245', 'rRNA_primary_transcript', marks=pytest.mark.xfail(reason="NYI")),
    pytest.param('URS00000FFD14_109352', 'rRNA_primary_transcript', marks=pytest.mark.xfail(reason="NYI")),
    pytest.param('URS00003A60A1_10090', 'rRNA_primary_transcript', marks=pytest.mark.xfail(reason="NYI")),
    pytest.param('URS00005CA2D5_6239', 'rRNA_primary_transcript', marks=pytest.mark.xfail(reason="NYI")),
    pytest.param('URS0000ABD87F_9606', 'rRNA_primary_transcript', marks=pytest.mark.xfail(reason="NYI")),
    pytest.param('URS0000ABD8C6_9606', 'rRNA_primary_transcript', marks=pytest.mark.xfail(reason="NYI")),
    pytest.param('URS0000ABD7E8_9606', 'rRNA_primary_transcript', marks=pytest.mark.xfail(reason="NYI")),
    ...
    pytest.param('URS0000D570F5_9606', 'lincRNA', marks=pytest.mark.xfail(reason="Too precise")),
    ...
    pytest.param('URS0000732D5D_9606', 'lincRNA', marks=pytest.mark.xfail(reason="Too specific")),
