...
@pytest.mark.parametrize('xml,result', [
    ('<sec><p>Alternative Uses Test: pretest and posttest</p></sec>', 'Alternative Uses Test: pretest and posttest'),
    ('<sec><p><bold>Alternative</bold> Uses Test: pretest and posttest</p></sec>', 'Alternative Uses Test: pretest and posttest'),
    ('<sec><p><bold><italic>Alternative Uses Test: pretest and posttest</italic></bold></p>.</sec>', 'Alternative Uses Test: pretest and posttest'),
