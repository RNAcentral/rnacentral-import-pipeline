...
@pytest.mark.parametrize(
    "species,assembly_id,host,expected",
    [
        (
            "amphiprion_ocellaris",
            "AmpOce1.0",
            urls.FtpHost.ensembl,
        ...
        (
            "drosophila_sechellia",
            "dsec_caf1",
            urls.FtpHost.ensembl_genomes,
            "ftp://ftp.ensemblgenomes.org/pub/current/metazoa/fasta/drosophila_sechellia/dna/Drosophila_sechellia.dsec_caf1.dna.toplevel.fa.gz",
        ),
        (
            "drosophila_sechellia",
            "dsec_caf1",
            urls.FtpHost.unknown,
            "ftp://ftp.ensemblgenomes.org/pub/current/metazoa/fasta/drosophila_sechellia/dna/Drosophila_sechellia.dsec_caf1.dna.toplevel.fa.gz",
        ),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "AmpOce1.0",
            urls.FtpHost.ensembl,
            "ftp://ftp.ensembl.org/pub/current_fasta/amphiprion_ocellaris/dna/Amphiprion_ocellaris.AmpOce1.0.dna_sm.toplevel.fa.gz",
        ),
        (
            "anolis_carolinensis",
            "AnoCar2.0",
            urls.FtpHost.ensembl,
            "ftp://ftp.ensembl.org/pub/current_fasta/anolis_carolinensis/dna/Anolis_carolinensis.AnoCar2.0.dna_sm.toplevel.fa.gz",
        ),
        (
            "homo_sapiens",
            "GRCh38",
        ...
        (
            ...
            "dsec_caf1",
            urls.FtpHost.ensembl_metazoa,
            "ftp://ftp.ensemblgenomes.org/pub/current/metazoa/fasta/drosophila_sechellia/dna/Drosophila_sechellia.dsec_caf1.dna_sm.toplevel.fa.gz",
        ),
        (
            "drosophila_sechellia",
            "dsec_caf1",
...
def test_can_get_all_paths_for_a_csv():
    ...
    assert list(urls.urls_for(data)) == [
        ...
        (
            "oryza_sativa",
            "IRGSP-1.0",
            "ftp://ftp.ensemblgenomes.org/pub/current/plants/fasta/oryza_sativa/dna/Oryza_sativa.IRGSP-1.0.dna.toplevel.fa.gz",
        ),
    ]
