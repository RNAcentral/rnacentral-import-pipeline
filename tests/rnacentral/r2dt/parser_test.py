...
@pytest.mark.parametrize('directory,source,urs,attr,expected', [
    ('data/r2dt/crw', data.Source.crw, 'URS00000F9D45_9606', 'fasta', 'data/r2dt/crw/URS00000F9D45_9606-d.5.e.H.sapiens.2.fasta'),
    ('data/r2dt/crw', data.Source.crw, 'URS00000F9D45_9606', 'svg', 'data/r2dt/crw/URS00000F9D45_9606-d.5.e.H.sapiens.2.colored.svg'),
    ('data/r2dt/rfam/', data.Source.rfam, 'URS0000A7635A', 'fasta', 'data/r2dt/rfam/RF00162/URS0000A7635A.fasta'),
    ('data/r2dt/rfam/', data.Source.rfam, 'URS0000A7635A', 'svg', 'data/r2dt/rfam/RF00162/URS0000A7635A.colored.svg'),
    ('data/r2dt/gtrnadb/', data.Source.gtrnadb, 'URS0000A0BF23', 'fasta', 'data/r2dt/gtrnadb/URS0000A0BF23.fasta'),
    ('data/r2dt/gtrnadb/', data.Source.gtrnadb, 'URS0000A0BF23', 'svg', 'data/r2dt/gtrnadb/URS0000A0BF23-E-Gln.colored.svg'),
])
...
@pytest.mark.parametrize('directory,source,urs,md5_hash', [
    ('data/r2dt/crw', data.Source.crw, 'URS00000F9D45_9606', '2204b2f0ac616b8366a3b5f37aa123b8'),
    ('data/r2dt/rfam', data.Source.rfam, 'URS0000A7635A', '9504c4b9a1cea77fa2c4ef8082d7b996'),
])
...
@pytest.mark.parametrize('directory,source,urs,secondary,bp_count', [
    ('data/r2dt/crw', data.Source.crw, 'URS00000F9D45_9606', '(((((((((....((((((((.....((((((............))))..))....)))))).)).(((((......((.((.(((....))))).)).....))))).)))))))))...', 35),
    ('data/r2dt/rfam', data.Source.rfam, 'URS0000A7635B', '((((((((......(((...(((.....)))......))).(((.(((......))))))........((((......))))...)))))))).', 24),
])
