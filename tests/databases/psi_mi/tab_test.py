...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("uniprotkb:O43426", [data.InteractionIdentifier("uniprotkb", "O43426", None)]),
        (
            "uniprotkb:P34708-1",
        ...
        ("rcsb pdb:1DYN", [data.InteractionIdentifier("rcsb pdb", "1DYN", None)]),
        (
        ...
        (
            ...
            [
                data.InteractionIdentifier(
                    "psi-mi",
                    "MI:0000",
                    "I can now use braces ()()() or pipes ||| here and ::colons::",
                )
            ],
        ),
        (
