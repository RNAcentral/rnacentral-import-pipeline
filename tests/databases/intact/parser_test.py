...
def test_produces_correct_data(sample):
    ...
    i1 = data.Interactor(
        ...
        taxid=559292,
        biological_role=[data.InteractionIdentifier('psi-mi', "MI:0499", 'unspecified role')],
        experimental_role=[data.InteractionIdentifier('psi-mi', "MI:0498", "prey")],
        interactor_type=[data.InteractionIdentifier('psi-mi', "MI:0609", 'small nucleolar rna')],
        xrefs=[],
        annotations=[],
    ...
    i2 = data.Interactor(
        ...
        aliases=[
            ...
            data.InteractionIdentifier('uniprotkb', 'U3 small nucleolar RNA-associated protein NOP1', 'gene name synonym'),
            data.InteractionIdentifier('uniprotkb', 'Histone-glutamine methyltransferase', 'gene name synonym'),
        ],
        taxid=559292,
        biological_role=[data.InteractionIdentifier('psi-mi', "MI:0499", 'unspecified role')],
        experimental_role=[data.InteractionIdentifier('psi-mi', "MI:0498", "prey")],
        ...
        xrefs=[
            data.InteractionIdentifier("go", "GO:0008649", "rRNA methyltransferase activity"),
            ...
            data.InteractionIdentifier("go", "GO:0000494", "box C/D snoRNA 3'-end processing"),
            ...
            data.InteractionIdentifier("go", "GO:0006356", "regulation of transcription by RNA polymerase I"),
            data.InteractionIdentifier("go", "GO:1990259", "histone-glutamine methyltransferase activity"),
            ...
            data.InteractionIdentifier("go", "GO:1990258", "histone glutamine methylation"),
            ...
            data.InteractionIdentifier("go", "GO:0008171", "O-methyltransferase activity"),
        ...
        annotations=[data.InteractionIdentifier('crc64', '56A8B958A7B6066E', None)],
