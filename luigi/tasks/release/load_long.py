...
class LoadLong(PGLoadSequences):  # pylint: disable=R0904
    """
    This will load all long sequences. The database paraemter defaults to all
    ...
    def directory(self):
        return os.path.join(output().base, 'long')
