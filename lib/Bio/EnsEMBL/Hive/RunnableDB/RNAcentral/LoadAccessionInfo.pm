...
=head1 NAME
    ...
    Bio::EnsEMBL::Hive::RunnableDB::RNAcentral::LoadAccessionInfo
...
package Bio::EnsEMBL::Hive::RunnableDB::RNAcentral::LoadAccessionInfo;
...
sub run {
    ...
    my $rnac = Bio::RNAcentral::SqlldrImportAccessionInfo->new($opt, 'ac_info');
    $rnac->update();
}
