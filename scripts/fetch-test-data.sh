...
<<<<<<< HEAD
fetch 'ftp://ftp.ensembl.org/pub/current_embl/mus_musculus/Mus_musculus.GRCm39.*.chromosome.3.dat.gz' 'data/ensembl/Mus_musculus.GRCm39.chromosome.3.dat'
fetch 'ftp://ftp.ensembl.org/pub/current_embl/macaca_mulatta/Macaca_mulatta.Mmul_10.106.primary_assembly.1.dat.gz' 'data/ensembl/Macaca_mulatta.Mmul_10.106.primary_assembly.1.dat'
=======
...
>>>>>>> eba97758f6c05aa3c7b879882b2f14e84b32b383
...
<<<<<<< HEAD
fetch 'ftp://ftp.ensemblgenomes.org/pub/current/plants/embl/hordeum_vulgare/Hordeum_vulgare.MorexV3*.primary_assembly.1H.dat.gz' 'data/ensembl_plants/Hordeum_vulgare.IBSC_v2.chromosome.Pt.dat'
...
fetch 'ftp://ftp.ensemblgenomes.org/pub/current/plants/embl/zea_mays/Zea_mays.Zm-B73-REFERENCE-NAM-5.*.chromosome.7.dat.gz' 'data/ensembl_plants/Zea_mays.Zm-B73REFERENCE-NAM-5.chromosome.7.dat'
...
fetch 'ftp://ftp.ensemblgenomes.org/pub/current/metazoa/embl/apis_mellifera/Apis_mellifera.Amel_HAv3.1*.primary_assembly.CM009931.2.dat.gz' 'data/ensembl_metazoa/Apis_mellifera.Amel_HAv3.1.primary_assembly.CM009931.2.dat'
=======
